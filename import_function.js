...
const functionAppUrl = getFunctionApp('Split', 'SplitTestFunction')
let functions = getFunctions('Split', 'SplitTestFunction');
let defaultKey = getFunctionKey('Split', 'SplitTestFunction')
let createApiPromise = createApi('lithographtestfunction', 'lithograph-test', name, displayName)
...
axios.all([functionAppUrl, functions, defaultKey, createApiPromise])
    .then(axios.spread((...responses) => {
        ...
        const apimKeyPromise = apimAddKeys('lithographtestfunction', 'lithograph-test', name, defaultKey);
        const apimBackendPromise = addApimBackend('lithographtestfunction', 'lithograph-test', name, 'SplitTestFunction', functionAppUrl);
